...
##Buttons
set_property PACKAGE_PIN U18 [get_ports button_d]						
	set_property IOSTANDARD LVCMOS33 [get_ports button_d]
	set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets button_d]
set_property PACKAGE_PIN T18 [get_ports button_b]						
	set_property IOSTANDARD LVCMOS33 [get_ports button_b]
	set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets button_b]
